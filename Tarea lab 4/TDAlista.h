...
void recorrerLista(TDAlista* lista)
{
  if (!esListaVacia(lista))
  {
    ...
    while (auxiliar!=NULL)
    {
      printf("[%d, %d] ",auxiliar->dato,auxiliar->dato2);
...
void insertarInicio(TDAlista* lista, int dato, int dato2)
{
...
//DOM: listaEnlazada x dato (int)
//REC: VOID
void insertarNodoFinal(TDAlista* lista, int dato, int dato2){
  nodo* auxiliar=lista->inicio;
...
//REC: VOID
void insertarNodoDespues(TDAlista* lista, int dato, int dato2, int datoAnterior){
  nodo* auxiliar=lista->inicio;
